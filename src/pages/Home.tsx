...
const Home: React.FC<HomeProps> = ({ navigate }) => {
  ...
  const testimonials = [
    {
      quote:
        "SoarHigh has given our daughter not only a brilliant academic start but the confidence to stand up and lead. We could not have asked for more.",
      name: "Mrs. Ngozi Eze",
      level: "Parent of Primary 4 student",
    },
    {
      quote:
        "The teachers know each child personally. My son walks into school excited every single morning — that tells you everything.",
      name: "Dr. Emeka Okafor",
      level: "Parent of JSS 2 student",
    },
    {
      quote:
        "From the moment we visited, we knew this was different. The discipline, the warmth, the standard — it all just felt right.",
      name: "Mr. & Mrs. Adaeze",
    ...
    <main>
        ...
        <div className="hero-content">
          ...
          <div className="hero-headline-wrap">
            {heroLines.map((line, i) => (
              <h1
                key={i}
                className={`hero-headline ${heroIdx === i ? "active" : ""}`}
              >
                {line}
              </h1>
            ))}
          ...
          <p className="hero-sub">
            A world-class nursery through secondary school experience in the
            heart of Enugu State.
          </p>
      ...
      <section className="section" style={{ background: "white" }}>
        <div className="container achievements-wrap">
          <div>
            ...
            >
              Across academics, sports and the arts, SoarHigh students
              consistently rank among the very best in Enugu State and beyond.
              Our trophy cabinet keeps growing — but what matters most is the
              confidence it builds in every child.
            </p>
            <a
              href="#"
              className="gold-link"
      ...
      <section className="about-preview">
        ...
        <div className="about-preview-text">
          ...
          >
            About SoarHigh Schools
          </h2>
          <p>
            Founded in Enugu in 2010, SoarHigh Schools has spent more than a
            decade quietly redefining what excellent African education looks
            like. We blend the Nigerian national curriculum with international
            best practice, holding every student to a single, simple standard:
            be the best version of yourself.
          </p>
          <p style={{ marginTop: 16 }}>
            Today, our graduates study at leading universities across Nigeria,
            the UK, the US and Canada — but they all return home for the same
            reason. SoarHigh shaped them.
          </p>
          <button
      ...
      <section className="section" style={{ background: "var(--warm-white)" }}>
        <div className="container text-center">
          ...
          <p className="section-sub">
            From a child's very first day to their university send-off — a
            single, continuous journey of growth.
          </p>
        </div>
        <div className="container" style={{ marginTop: 56 }}>
      ...
      <section className="virtual-tour">
        <div className="container text-center">
          ...
          >
            Take a 360° virtual walkthrough of our world-class facilities — from
            ...
            {testimonials.map((t, i) => (
              <Reveal key={i} delay={i * 120}>
                <div className="testimonial">
                  ...
                  <div className="stars">
                    {[0, 1, 2, 3, 4].map((s) => (
                      <Icon.star key={s} width={16} height={16} />
                    ))}
                  </div>
